...
function favHover(x){
    x.src= 'images/icons/icon-fav-hover.svg'; 
}
function favNormal(x){
  x.src= 'images/icons/icon-fav.svg'; 
}

function expHover(x){
  x.src= 'images/icons/icon-max-hover.svg'; 
}
function expNormal(x){
x.src= 'images/icons/icon-max-normal.svg'; 
}

function dwHover(x){
  x.src= 'images/icons/icon-download-hover.svg'; 
}
function dwNormal(x){
